Rails.application.routes.draw do
  ...
  get 'pages/forgot-password', to: 'pages#forgot_password', as: :pages_forgot_password
  get 'pages/lock-screen', to: 'pages#lock_screen', as: :pages_lock_screen
  get 'pages/blank', to: 'pages#blank', as: :pages_blank
  get 'pages/search', to: 'pages#search', as: :pages_search
  get 'pages/error-404', to: 'pages#error_404', as: :pages_error_404
  get 'pages/error-500', to: 'pages#error_500', as: :pages_error_500

  # Data visualization routes
  get 'chartjs', to: 'visualization#chartjs', as: :chartjs
  get 'am_charts', to: 'visualization#am_charts', as: :am_charts
  get 'map/simple', to: 'visualization#simple_map', as: :simple_map
  get 'map/events', to: 'visualization#events_map', as: :events_map
  get 'map/markers', to: 'visualization#markers_map', as: :markers_map
  get 'map/geo-location', to: 'visualization#geo_location_map', as: :geo_location_map
  get 'map/geo-coding', to: 'visualization#geo_coding_map', as: :geo_coding_map
  get 'map/data', to: 'visualization#data_maps', as: :data_maps
  get 'map/am', to: 'visualization#am_maps', as: :am_maps
  get 'overlay', to: 'visualization#overlay', as: :overlay
  get 'overlay/polylines', to: 'visualization#overlay_polylines', as: :overlay_polylines
  get 'overlay/overlay-polygons', to: 'visualization#overlay_polygons', as: :overlay_polygons
  get 'geo-json-polygons', to: 'visualization#geo_json_polygons', as: :geo_json_polygons
  get 'routes/map', to: 'visualization#map_routes', as: :map_routes
  get 'routes/advance', to: 'visualization#advance_routes', as: :advance_routes
  ...
  get 'components/button-group', to: 'components#button_group', as: :components_button_group
  get 'components/card', to: 'components#card', as: :components_card
  get 'components/card-group', to: 'components#card_group', as: :components_card_group
  ...
  get 'components/input-group', to: 'components#input_group', as: :components_input_group
  get 'components/jumbotron', to: 'components#jumbotron', as: :components_jumbotron
  get 'components/list-group', to: 'components#list_group', as: :components_list_group
  ...
  get 'components/progress-bar', to: 'components#progress_bar', as: :components_progress_bar
  ...
  get 'extracomponents/code-editor', to: 'extracomponents#code_editor', as: :extracomponents_code_editor
  get 'extracomponents/date-time_picker', to: 'extracomponents#date_time_picker', as: :extracomponents_date_time_picker
  get 'extracomponents/color-picker', to: 'extracomponents#color_picker', as: :extracomponents_color_picker
  get 'extracomponents/sweet-alerts', to: 'extracomponents#sweet_alerts', as: :extracomponents_sweet_alerts
