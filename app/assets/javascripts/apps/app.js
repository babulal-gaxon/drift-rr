(function ($) {
    ...
    var dtModule = {
        ...
        calculateHeight: function () {
            ...
            var th = h_Height + pc_Padding + ph_Height + f_Height;
            ...
            var pmh_Height = this.appModuleHeader.outerHeight(true);
            ...
            if (w_Width > 767) {
                ...
                var ms_height = this.appModuleSidebar.outerHeight();
            }

            this.appModuleContent.css('height', (moduleHeight - (pmc_MarginTop + pmh_Height + ms_height + commentBoxHeight)) + 'px');
            ...
            this.appModuleSidebar.find('.dt-module__sidebar-content').height(sc_height);
