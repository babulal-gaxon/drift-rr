(function ($) {
    ...
    new Chart(ctxProperties, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    pointRadius: 0,
                backgroundColor: color('#867AE5').alpha(0.9).rgbString(),
                borderColor: color('#867AE5').alpha(0.9).rgbString(),
                hoverBorderColor: color('#867AE5').alpha(0.9).rgbString(),
                    pointBorderWidth: 0,
    ...
    $('.dt-chart .action-btn').each(function(){
        $(this).on('click', function(){
            drift.addClass(this, '.dt-chart', 'dt-chart__reveal')
        });
    });
    
    $('.dt-chart .close-btn').each(function(){
        $(this).on('click', function(){
            drift.removeClass(this, '.dt-chart', 'dt-chart__reveal')
        });
    });
